...
def submit_data():
    ...
    wb = Workbook()
    ws = wb.active
    final_working_directory = "static\\Report\\{}.xlsx"
    file_name = "Cleaning_room_report_{}".format(str(datetime.datetime.today().strftime('%d_%m_%Y')))
    final_working_directory = final_working_directory.format(file_name)
