...
function upload(url) {
  ...
  request.upload.addEventListener("progress", function (e) {
    ...
    document.getElementById("progress").setAttribute("style", `width: ${Math.floor(percent_complete)}%`);
    document.getElementById("progress_status").innerText = `${Math.floor(percent_complete)}% uploaded`;
  ...
  request.addEventListener("load", function (e) {
    ...
    if (request.status == 200) {
	  ...
	  show_alert("File Uploaded", alert)
...
function input_filename() {
  ...
  document.getElementById("file_input_label").innerText = file_input.files[0].name;
